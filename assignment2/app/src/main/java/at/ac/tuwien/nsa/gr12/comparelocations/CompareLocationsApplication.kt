...
import at.ac.tuwien.nsa.gr12.comparelocations.adapter.google.location.service.GoogleLocationServiceAdapter
...
class CompareLocationsApplication : Application(), KodeinAware {
    override val kodein = Kodein.lazy {
        ...
        bind<GoogleLocationServicePort>() with singleton { GoogleLocationServiceAdapter() }
